...
const Notfound = () => {
  ...
  const goBack = () => {
    history(-1); // This will navigate to the previous page
  };
    ...
    <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div class="wf-ull lg:w-1/2">
            ...
            <div class="flex items-center mt-6 gap-x-3">
                <button onClick={()=>goBack()}  class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
            ...
            <div class="mt-10 space-y-6">
                <div>
                    <Link to={'/About'} class="inline-flex items-center text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline">
                        <span>About</span>
                ...
                <div>
                    <Link to={'/Blogs'} class="inline-flex items-center text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline">
                        <span>Our blog</span>
                ...
                <div>
                    <Link to={'/Login'} class="inline-flex items-center text-sm text-blue-500 gap-x-2 dark:text-blue-400 hover:underline">
                        <span>Sing up</span>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">join white us</p>
                </div>
            </div>
        </div>
